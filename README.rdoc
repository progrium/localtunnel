...
Close your laptop lid and put your machine to sleep for a bit, then reopen the
lid, and start over at step 1

Using an extensibility approach inspired by Rails generators, you can write
...
Place it in a file named my_class_auto_config.rb under a localtunnel subdirectory.
(Where "my_class_auto_config" corresponds to the "class MyClassAutoConfig" class name.)
